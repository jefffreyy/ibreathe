...
class Device_model extends CI_Model {
    ...
    public function add_device($data) {
        ...
        $sensors = array(
            ...
            array('device_id' => $device_id, 'sensor_type' => 'gas', 'unit' => 'pm2.5', 'min_range' => 0, 'max_range' => 5000),
            array('device_id' => $device_id, 'sensor_type' => 'pm25', 'unit' => 'μg/m³', 'min_range' => 0, 'max_range' => 500)
        );
