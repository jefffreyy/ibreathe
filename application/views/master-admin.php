            ...
            <div class="container my-5">
                <div class="row justify-content-center">
                    <div class="col-md-4 mb-4">
                        <a href="<?php echo base_url(); ?>masteradmin/manage_masterlist" class="text-decoration-none">
                            <div class="card text-center rounded-4 shadow-sm bg-primary text-white">
                                <div class="card-body">
                                    <h5 class="card-title">Manage Masterlist</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-4 mb-4">
                        <a href="<?php echo base_url(); ?>masteradmin/manage_librarian" class="text-decoration-none">
                            <div class="card text-center rounded-4 shadow-sm bg-success text-white">
                                <div class="card-body">
                                    <h5 class="card-title">Manage Librarian Account</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                 ...
                 <!-- <div class="row justify-content-center">
                    ...
                    <div class="col-md-4 mb-4">
                        <a href="<?php echo base_url(); ?>masteradmin/summaryreport" class="text-decoration-none">
                            <div class="card text-center rounded-4 shadow-sm bg-warning text-white">
                                <div class="card-body">
