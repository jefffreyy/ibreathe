            ...
            <div class="col-lg-8">
                <div class="card scada-card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <?php
                            $sensor_icons = array('temperature'=>'fa-thermometer-half text-danger','humidity'=>'fa-tint text-info','co2'=>'fa-cloud text-warning','gas'=>'fa-smog text-success','co'=>'fa-skull-crossbones text-warning');
                            $sensor_units = array('temperature'=>'°C','humidity'=>'%','co2'=>'µg/m³','gas'=>'μg/m³','co'=>'ppm');
                            $readings_map = array();
                            foreach ($latest_readings as $r) { $readings_map[$r->sensor_type] = $r; }
                            foreach (array('temperature','humidity','gas','co') as $type):
