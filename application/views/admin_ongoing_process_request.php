                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-lg-2">
                        <div class="list-group">
                            <a href="<?= base_url('admin/reservation_request') ?>" class="list-group-item list-group-item-action">Reservation Request</a>
                            <a href="<?= base_url('admin/ongoing_request') ?>" class="list-group-item list-group-item-action active bg-warning border-0 fw-bold text-dark">Ongoing Reservation</a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-9 col-lg-10">
                        ...
                        <div class="p-4 rounded detail-card">
                            ...
                            <div class="mb-4">
                                <p class="mb-0 fw-bold">Seats Assigned:</p>
                                <p><?php echo nl2br(htmlspecialchars($request['seat_assigned'])); ?></p>
                            </div>
                            ...
                            <div class="d-flex justify-content-end mt-4 mb-0 pb-0">
                                <form method="post" action="<?= site_url('admin/terminated_reservation/' . $request['id']); ?>">
                                    <button class="btn btn-sm btn-danger" type="submit">Terminate</button>
                                </form>
                            </div>
                        </div>
