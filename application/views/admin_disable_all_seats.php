...
<body>
    ...
    <div class="form-wrapper">
        <div class="form-container">
            <h4 class="text-center mb-3">Disable All Seats</h4>
            <form id="disabledSeatForm" method="post" action="<?= site_url('admin/disable_all_seats') ?>">
                <div class="mb-3">
                    <label class="form-label">All seats will be disabled, regardless of their current status (e.g., closed or occupied). Affected users will be notified.</label>
                </div>
                <div class="mb-3">
