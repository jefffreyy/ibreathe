            ...
            <form action="<?php echo base_url() . 'index/registerUser' ?>" method="post">
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input id="lname" name="lname" class="form-control" placeholder="Type here" required>
                    </div>
                    <div class="col-md-4">
                        <label for="fname" class="form-label"><b>First Name</b></label>
                        <input id="fname" name="fname" type="text" class="form-control" placeholder="Type here" required>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="radio" name="role" value="Student" class="form-check-input" required> <b>Student</b>
                    <input type="radio" name="role" value="Professor" class="form-check-input ms-3" required> <b>Professor</b>
                </div>

                <div class="row mb-3">
                    <div class="col-md-4">
                        <label for="student_id" class="form-label"><b>ID Number</b> (This will be your username)</label>
                        <input id="student_id" name="student_id" type="text" class="form-control" placeholder="Type here" required>
                    </div>
                    <div class="col-md-4">
                        <label for="password" class="form-label"><b>Password</b></label>
                        <input id="password" name="password" type="password" class="form-control" placeholder="Type here" required>
                    </div>
                    <div class="col-md-4">
                        <label for="re-password" class="form-label"><b>Confirm Password</b></label>
                        <input id="re-password" name="re_password" type="password" class="form-control" placeholder="Type here" required>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <select class="form-select" name="secquestion" required>
                    ...
                    <div class="col-md-4">
                        <label for="answer1" class="form-label"><b>Security Answer</b></label>
                        <input id="answer1" name="answer1" type="password" class="form-control" placeholder="Type here" required minlength="4">
                    </div>
                    <div class="col-md-4">
                        <label for="answer2" class="form-label"><b>Confirm Security Answer</b></label>
                        <input id="answer2" name="answer2" type="password" class="form-control" placeholder="Type here" required>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-5">
                        ...
                        <select class="form-select" name="department" required>
                            <option value="">Select here</option>
                            <option value="COECSA">COECSA (College of Engineering, Computer Science and Architecture)</option>
                            <option value="CAMS">CAMS (College of Allied Medical Science)</option>
                            <option value="CON">CON (College of Nursing)</option>
                            <option value="CITHM">CITHM (College of International Tourism and Hospitality Management)</option>
                            <option value="CBA">CBA (College of Business Administration)</option>
                            <option value="CFAD">CFAD (College of Fine Arts and Design)</option>
                            <option value="CLAE">CLAE (College of Liberal Arts and Education)</option>
                            <option value="IHS">International High School (Junior and Senior High School)</option>
                            <option value="GS">Graduate School (Masteral and Doctoral Degree)</option>
                        </select>
                    </div>
                </div>
                <div class="mt-4 mb-3">
                ...
                <center><br>
                    <div class="g-recaptcha" data-sitekey="6LdhljErAAAAAAOkq57RSQoeJY6aT66eQBX5rG4z"></div><br>
                </center>

                <div class="d-flex justify-content-end mt-3">
                    <button type="button" class="btn btn-danger me-2" onclick="window.location.href='<?= base_url('index/') ?>'">Cancel</button>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            document.querySelector("form").addEventListener("submit", function(event) {
                ...
                let department = document.querySelector('select[name="department"]').value.trim();
                let secquestion = document.querySelector('select[name="secquestion"]').value.trim();
                ...
                // Check required fields for non-empty (non-space) input
                if (lname === "" || fname === "" || mname === "" || student_id === "" ||
                    password === "" || confirmPassword === "" ||
                    answer1 === "" || answer2 === "" || department === "" || secquestion === "") {
                    errorMessage = "All fields must be filled out with valid input.";
                    ...
                    errorMessage = "You must select 'I Agree' to proceed.";
                } else if (agreement.value !== "agree") {
                    errorMessage = "You must agree to the terms to register.";
                }
