...
<body>
    <div class="wrapper">
                    ...
                    <div class="col-md-9 col-lg-10">
                        ...
                        <div class="p-4 rounded detail-card">
                            ...
                            <div class="d-flex justify-content-end mt-4 mb-0 pb-0">
                                <button type="button" class="btn btn-danger btn-sm me-2" data-bs-toggle="modal" data-bs-target="#rejectModal">Reject</button>
                                <a href="<?= site_url('admin/selectseats/' . $request['id']) ?>" class="btn btn-success btn-sm">Proceed</a>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="rejectModal" tabindex="-1" aria-labelledby="rejectModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form method="post" action="<?= site_url('admin/reject_request/' . $request['id']) ?>">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="rejection_reason" class="form-label">Please enter a reason:</label>
