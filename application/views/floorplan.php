                        ...
                        <div class="floorplan-wrapper">
                            <svg id="floorplan-svg" viewBox="0 0 1000 650" preserveAspectRatio="xMidYMid meet">
                                ...
                                <g id="device-kitchen" class="device-group" transform="translate(50, 405)">
                                    ...
                                    <g transform="translate(16, 118)"><rect width="250" height="55" rx="8" fill="#fef9e7" stroke="#fde3a7" stroke-width="0.5"/><text x="8" y="18" font-size="9" fill="#e67e22" font-family="Inter, sans-serif" font-weight="600"><tspan font-family="Font Awesome 5 Free" font-weight="900">&#xf0e7;</tspan> Gas</text><text x="8" y="42" font-size="20" font-weight="800" fill="#1e293b" font-family="Inter, sans-serif" class="val-gas">0</text><text x="60" y="42" font-size="11" fill="#94a3b8" font-family="Inter, sans-serif">ppm</text></g>
                                </g>
                                ...
                                <g id="device-bathroom" class="device-group" transform="translate(385, 405)">
                                    ...
                                    <g transform="translate(14, 118)"><rect width="222" height="55" rx="8" fill="#fef9e7" stroke="#fde3a7" stroke-width="0.5"/><text x="8" y="18" font-size="9" fill="#e67e22" font-family="Inter, sans-serif" font-weight="600"><tspan font-family="Font Awesome 5 Free" font-weight="900">&#xf0e7;</tspan> Gas</text><text x="8" y="42" font-size="20" font-weight="800" fill="#1e293b" font-family="Inter, sans-serif" class="val-gas">0</text><text x="55" y="42" font-size="11" fill="#94a3b8" font-family="Inter, sans-serif">ppm</text></g>
                                </g>
                    ...
                    <div class="card-body py-3 px-3">
                        ...
                        <div>
                            ...
                            <div class="d-flex flex-wrap mt-2" style="gap:8px">
                                ...
                                <span class="badge badge-warning" style="font-size:10px; background-color:#e67e22; color:white"><i class="fas fa-cloud mr-1"></i>Gas (ppm)</span>
                            </div>
                        </div>
                    </div>
                </div>
