...
<div class="header">
    ...
    <div class="container">
        ...
        <br>
        <p>You can reserve only on the current Month</p>
        <br>
      <button class="btn btn-secondary" onclick="window.location.href='https://library.systems-test.com/index/check_status/8/2025-05-31'">← Back to Reservation</button>
