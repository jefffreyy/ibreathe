                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-lg-2">
                        <div class="list-group">
                            <a href="<?= base_url('admin/reservation_request') ?>" class="list-group-item list-group-item-action active bg-warning border-0 fw-bold text-dark">Reservation Request</a>
                            <a href="<?= base_url('admin/ongoing_request') ?>" class="list-group-item list-group-item-action">Ongoing Reservation</a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-9 col-lg-10">
                        <?php if (!empty($requests)): ?>
                            <?php foreach ($requests as $request): ?>
                                <a href="<?php echo base_url('admin/process_request/' . $request['id']); ?>"
                                    class="reservation-entry d-flex justify-content-between align-items-center">
                                    <span>📅 Requested Date: <?php echo date('m/d/Y', strtotime($request['date'])); ?></span>
                                    <span><?php echo htmlspecialchars($request['prof_name']); ?></span>
                                    <span><?php echo htmlspecialchars($request['prof_id']); ?></span>
                                    <span class="badge bg-secondary"><?php echo $request['status']; ?></span>
                                </a>    
                            <?php endforeach; ?>
                        <?php else: ?>
