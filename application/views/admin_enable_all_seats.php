...
<body>
    ...
    <div class="form-wrapper">
        <div class="form-container">
            <h4 class="text-center mb-3">Enable All Seats</h4>
            <form id="disabledSeatForm" method="post" action="<?= site_url('admin/enable_all_seats') ?>">
                <div class="mb-3">
                    <label class="form-label">All seats will be enabled.</label>
                </div>
                <div class="mb-3">
                    <label for="date_disabled" class="form-label">Date Enabled</label>
